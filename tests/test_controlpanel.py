...
class TestControlPanel:
    def test_validator(self, portal):
    ...
    def test_memberpropertytogroup_controlpanel_view(self, portal, http_request):
        view = api.content.get_view(
            "memberpropertytogroup-controlpanel", portal, http_request
        )
        assert view is not None

    def test_memberpropertytogroup_controlpanel_view_protected(self, anon_portal):
        with pytest.raises(Unauthorized):
            anon_portal.restrictedTraverse("@@memberpropertytogroup-controlpanel")

    def test_memberpropertytogroup_in_controlpanel(self, portal):
    ...
    def test_record_group_property(self, registry):
    ...
    def test_record_valid_groups(self, registry):
        record = registry.records[
            "pas.plugins.memberpropertytogroup.interfaces."
